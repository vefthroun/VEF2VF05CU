...
Hér eru fleiri dæmi með [TMDB endpoints](JSON/tmdb_endpoints.md).<br>
Leikarar ákveðinnar myndar: 'https://api.themoviedb.org/3/movie/{id}/credits?api_key={þinn_lykill}<br>
